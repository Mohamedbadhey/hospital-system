<%@ Page Title="Inpatients Management" Language="C#" MasterPageFile="~/doctor.Master" AutoEventWireup="true" CodeBehind="registre_inpatients.aspx.cs" Inherits="juba_hospital.registre_inpatients" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        ...
        function printAllInpatients() {
            ...
            window.open('print_all_inpatients.aspx?patientids=' + patientIds.join(','), '_blank');
        }
        ...
        function applyFilters() {
            ...
            $('.patient-card').each(function () {
                ...
                if (showCard && selectedDate && !isNaN(selectedDate)) {
                    ...
                    if (match && new Date(match[1]).toDateString() !== selectedDate.toDateString()) showCard = false;
                }
