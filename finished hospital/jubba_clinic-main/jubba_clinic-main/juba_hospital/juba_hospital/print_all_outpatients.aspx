<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="print_all_outpatients.aspx.cs" Inherits="juba_hospital.print_all_outpatients" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta charset="utf-8" />
    <title>Outpatients Report - Print</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="report-container">
            <!-- Report Title -->
            <div class="report-title">📋 Outpatients Report</div>
