<%@ Page Title="Outpatients Management" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="registre_outpatients.aspx.cs" Inherits="juba_hospital.registre_outpatients" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        ...
        $('#filterDate').on('change', function () {
            ...
            $('.patient-card').each(function () {
                var dateText = $(this).find('p:contains("Registered:")').text();
                var match = dateText.match(/Registered: (.+)/);
                if (match) {
                    var cardDate = new Date(match[1]);
                    var isSameDay = cardDate.toDateString() === selectedDate.toDateString();
                    $(this).toggle(isSameDay);
                }
            });
        });
    </script>
