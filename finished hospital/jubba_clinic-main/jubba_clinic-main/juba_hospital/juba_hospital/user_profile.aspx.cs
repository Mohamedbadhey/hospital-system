...
namespace juba_hospital
{
    public partial class user_profile : System.Web.UI.Page
    {
        ...
        {
            // Fallback generic: if role mapping needed, ensure not blank
            if (Session["role_id"] != null)
            {
                int rid;
                if (int.TryParse(Session["role_id"].ToString(), out rid))
                {
                    switch (rid)
                    {
                        case 1: return "doctor";
                        case 2: return "lab_user";
                        case 3: return "registre";
                        case 4: return "admin";
                        case 5: return "xrayuser";
                        case 6: return "pharmacy_user";
                    }
                }
            }
            return "admin";
        ...
        {
            // Most user tables use 'userid'; doctor uses 'doctorid'
