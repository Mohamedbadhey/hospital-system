<%@ Page Title="Bed Charges Revenue Report" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="bed_revenue_report.aspx.cs" Inherits="juba_hospital.bed_revenue_report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <div>
                            <h4 class="card-title"><i class="fas fa-bed"></i> Bed Charges Revenue Report</h4>
                            <p class="card-category">Detailed analysis of inpatient bed charges and revenue</p>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="stat-box">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="revenue-stat">
                                    <p class="mb-0"><strong>Total Charges</strong></p>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover" id="bedChargesTable">
                            <thead>
                                <tr>
                                    <th>Invoice #</th>
                                    <th>Patient ID</th>
    ...
    <script>
        ...
        function loadReport() {
            ...
            $.ajax({
                type: "POST",
                url: "bed_revenue_report.aspx/GetBedReport",
        ...
        function updateTable(details) {
            ...
            dataTable = $('#bedChargesTable').DataTable({
                dom: 'Bfrtip',
        ...
        function markAsPaid(chargeId) {
            ...
            $.ajax({
                type: "POST",
                url: "bed_revenue_report.aspx/MarkAsPaid",
        ...
        function printProfessionalReport() {
            ...
            var url = 'print_bed_revenue_report.aspx?';
