...
{
    public partial class print_all_discharged : System.Web.UI.Page
    {
        ...
        private void LoadPatients()
        {
            ...
            // Debug logging
            System.Diagnostics.Debug.WriteLine("Discharged Print - Patient IDs: " + patientIds);
            ...
            using (SqlConnection con = new SqlConnection(cs))
            {
                string query = $@"
                    SELECT 
                        ...
                        p.sex,
                        ISNULL(p.patient_type, 'outpatient') as patient_type,
                        p.phone,
                        p.location,
                        p.date_registered,
                    ...
                    GROUP BY p.patientid, p.full_name, p.dob, p.sex, p.patient_type, p.phone, p.location, p.date_registered
