...
{
    public partial class completed_patient_full_report : System.Web.UI.Page
    {
        ...
        private void LoadFullReport(string patientId, string prescid)
        {
            ...
            using (SqlConnection con = new SqlConnection(cs))
            {
                ...
                // Section 2: VISIT & COMPLETION INFORMATION
        ...
        private string GetVisitInfo(SqlConnection con, string patientId, string prescid)
        {
            StringBuilder html = new StringBuilder();
            html.Append("<div class='section'>");
            html.Append("<div class='section-title'>🏥 VISIT & COMPLETION INFORMATION</div>");
            ...
            using (SqlCommand cmd = new SqlCommand(query, con))
            {
                ...
                using (SqlDataReader dr = cmd.ExecuteReader())
                {
                    if (dr.Read())
                    {
                        ...
                        html.Append($"<div class='info-row'><div class='info-label'>Patient Type:</div><div class='info-value'><span class='badge badge-primary'>Completed Patient</span></div></div>");
                    }
                    else
                    {
                        html.Append("<p>No VISIT & COMPLETION INFORMATION found.</p>");
                    }
                }
            }
        ...
        private string GetAllLabTestsWithResults(SqlConnection con, string patientId, string specificPrescid = null)
        {
            ...
            // Get all LAB ORDERS for this patient (optionally filtered by prescid for Completed Patients)
            string prescQuery = @"
                SELECT 
            ...
            // For Completed Patients, filter by specific prescid if provided
        ...
        private string GetSummary(SqlConnection con, string patientId)
        {
            ...
            html.Append("<div class='summary-box'>");
            html.Append("<p><strong>This report provides a comprehensive overview of the patient's Completed Patient visit including:</strong></p>");
            html.Append("<ul>");
