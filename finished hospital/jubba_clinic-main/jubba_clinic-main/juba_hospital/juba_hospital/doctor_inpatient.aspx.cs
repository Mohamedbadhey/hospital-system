...
,
        ...
        /// </summary>
        [WebMethod]
        public static PatientHistory[] GetPatientHistoryDoctor(string patientId, string prescid)
        {
            ...
            {
                throw new Exception("GetPatientHistoryDoctor Error: " + ex.Message);
            }
        }
        ...
        /// </summary>
        [WebMethod]
        public static string SavePatientHistoryDoctor(string patientId, string prescid, string historyText, string createdBy)
        {
            string cs = ConfigurationManager.ConnectionStrings["DBCS"].ConnectionString;
        ...
        /// </summary>
        [WebMethod]
        public static string UpdatePatientHistoryDoctor(string historyId, string historyText, string updatedBy)
        {
            string cs = ConfigurationManager.ConnectionStrings["DBCS"].ConnectionString;
        ...
        /// </summary>
        [WebMethod]
        public static string DeletePatientHistoryDoctor(string historyId)
        {
            string cs = ConfigurationManager.ConnectionStrings["DBCS"].ConnectionString;
