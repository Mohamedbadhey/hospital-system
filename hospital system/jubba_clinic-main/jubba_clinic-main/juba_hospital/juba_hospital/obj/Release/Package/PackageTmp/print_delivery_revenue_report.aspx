<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="print_delivery_revenue_report.aspx.cs" Inherits="juba_hospital.print_delivery_revenue_report" %>

<!DOCTYPE html>
<html>
<head>
    <title>Delivery Charges Revenue Report - Print</title>
    ...
    <style>
        * {
        ...
        tfoot td {
            font-weight: bold;
            background: linear-gradient(135deg, #ffd6e8 0%, #ffe6f0 100%);
            font-size: 14px;
            padding: 15px 12px;
            border: 2px solid #e83e8c;
        }
...
<body>
    ...
    <div class="report-title-section">
        <h2 class="report-title">Delivery Charges Revenue Report</h2>
    </div>

    <!-- Report Information -->
    <div class="report-info">
        <p><strong>Report Period:</strong> <asp:Literal ID="litDateRange" runat="server"></asp:Literal></p>
        <p><strong>Filter Applied:</strong> <asp:Literal ID="litFilter" runat="server">All Delivery Charges</asp:Literal></p>
    ...
    <table>
        ...
        <tbody>
            <asp:Repeater ID="rptDeliveryCharges" runat="server">
                <ItemTemplate>
                    <tr>
