<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="print_lab_revenue_report.aspx.cs" Inherits="juba_hospital.print_lab_revenue_report" %>
...
<head>
    ...
    <style>
        * {
        ...
        thead {
            background: linear-gradient(135deg, #3DB2E9 0%, #2a8fc1 100%);
            color: white;
        }
...
<body>
    ...
    <div class="report-title-section">
        <h2 class="report-title">Laboratory Revenue Report</h2>
    </div>

    <!-- Report Information -->
    <div class="report-info">
        <p><strong>Report Period:</strong> <asp:Literal ID="litDateRange" runat="server"></asp:Literal></p>
        <p><strong>Filter Applied:</strong> <asp:Literal ID="litFilter" runat="server">All Lab Tests</asp:Literal></p>
            ...
            <asp:Repeater ID="rptLabTests" runat="server">
                <ItemTemplate>
                    <tr>
                        ...
                        <td><%# Eval("test_date", "{0:MMM dd, yyyy}") %></td>
                        <td><%# Eval("test_date", "{0:hh:mm tt}") %></td>
